...
<body>
	...
	<div class="container_content">
		...
		<form action="ManagerUserServlet" method="post" onsubmit="return validateLoginInput()">
	...
	<div class="container_content">
		...
		<h2>Se sei nuovo possiamo conoscerci meglio! Registrati al nostro sito:</h2><br>			
		 
   		 <form id="registrationForm" action="ManagerUserServlet" method="post" onsubmit="return validateRegistrationInput()">  		    		 
