...
public class ManagerOrdiniServlet extends HttpServlet {
    ...
    private void mostraComponentiOrdine(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
     ...
     /*if (componenti != null && !componenti.isEmpty()) {
         ...
         html.append("<h1>Dettagli dell'Ordine #").append(request.getParameter("ordineId")).append(":</h1>");
         html.append("<ul>");
         for (ComponeBean componente : componenti) {
             html.append("<li>");
             html.append("<p> Prodotto: ").append(componente.getNome()).append(", ");
             html.append("Prezzo: &euro;").append(componente.getPrezzo()).append(", ");
             html.append("Quantità: ").append(componente.getQuantita()).append("</p> ");
     ...
     if (componenti != null && !componenti.isEmpty()) {
         ...
         html.append("<ul>");
         for (ComponeBean componente : componenti) {
             html.append("<li class='cart-item'>");
             html.append("<img src='GetPictureServlet?action=articoloPicture&id=").append(componente.getIdArticolo()).append("' alt='").append(componente.getNome()).append("'>");
             html.append("<div class='cart-item-content'>");
             html.append("<p><strong>Prodotto:</strong> ").append(componente.getNome()).append("</p>");
             html.append("<p><strong>Prezzo:</strong> &euro;").append(componente.getPrezzo()).append("</p>");
             html.append("<p><strong>Quantità:</strong> ").append(componente.getQuantita()).append("</p>");
             html.append("</div>");
             html.append("</li>");
         }
         html.append("</ul>");
